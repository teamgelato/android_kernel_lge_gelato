...
#define CONFIG_LGE_AUDIO_HEADSET_PROTECT
#define DEBUG_H2W
#ifdef DEBUG_H2W
...
enum {
	...
	//MS910_LGE_CHANGE_AUDIO [jy0127.jang@lge.com] 2011-03-16 // audio path for 3 pole headset    
	LGE_NO_MIC_HEADSET = 1<<6,
};
...
MODULE_AUTHOR("Kiwone,Seo <kiwone.seo@lge.com>");
