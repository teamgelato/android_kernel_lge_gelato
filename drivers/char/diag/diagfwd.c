...
void diag_process_hdlc(void *data, unsigned len)
{
	...
	int ret, type = 0;
// LGE_CHANGE_S [2011.02.12] [myeonggyu.son@lge.com] [gelato] to execute double 0x7E tails[START]	
/* LG_FW : 2009.02.05 khlee - bug fix */ 	
#ifdef CONFIG_LGE_DIAG
	unsigned int nTempLen = 0;  
#endif
// LGE_CHANGE_E [2011.02.12] [myeonggyu.son@lge.com] [gelato] to execute double 0x7E tails [END]
#ifdef DIAG_DEBUG
	int i;
